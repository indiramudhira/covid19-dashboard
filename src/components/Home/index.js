...
class Home extends Component {
  ...
  renderAllNationalData = () => {
    ...
    return (
      <>
        <div data="countryWideConfirmedCases" className="stats-block-column">
        ...
        <div data="countryWideActiveCases" className="stats-block-column">
        ...
        <div data="countryWideRecoveredCases" className="stats-block-column">
        ...
        <div data="countryWideDeceasedCases" className="stats-block-column ">
  ...
  renderAllStatesList = () => {
    ...
    return (
      <div className="all-states-table" data="stateWiseCovidDataTable">
  ...
  showSearchList = () => {
    ...
    return (
      <ul className="search-result-container" data="searchResultsUnorderedList">
        ...
        <div className="home-container">
          <div className="home-content-container">
            <div className="search-container">
              <BsSearch data="searchIcon" className="search-icon" />
              <input
                type="search"
