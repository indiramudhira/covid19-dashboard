    ...
    return (
      <>
        <ul className="ul-list-each-state ">
          ...
          >
            <div data="stateSpecificConfirmedCasesContainer">
          ...
          >
            <div data="stateSpecificActiveCasesContainer">
          ...
          >
            <div data="stateSpecificRecoveredCasesContainer">
          ...
          >
            <div data="stateSpecificDeceasedCasesContainer">
